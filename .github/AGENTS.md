...
## Repository Defaults
- Primary focus: Shared platform repository for reusable GitHub automation, Terraform modules, and cross-team engineering standards.
- Profile hint: `mixed-platform`
